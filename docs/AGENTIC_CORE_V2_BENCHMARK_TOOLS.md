# SkyClaw Agentic Core v2.0 — Tool-Heavy A/B Benchmark Report
...
- **Fresh state**: Both `~/.skyclaw/memory.db` and per-version `memory.db` cleaned before run
...
*Generated by SkyClaw Agentic Core v2.0 benchmark harness*
