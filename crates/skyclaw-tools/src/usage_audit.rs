...
use skyclaw_core::{Tool, ToolContext, ToolDeclarations, ToolInput, ToolOutput, UsageStore};
...
impl UsageAuditTool {
    ...
    async fn handle_summary(&self, ctx: &ToolContext) -> Result<ToolOutput, SkyclawError> {
...
mod tests {
    use super::*;
    use skyclaw_core::{UsageRecord, UsageSummary};
    ...
    impl UsageStore for MockUsageStore {
        ...
        async fn is_usage_display_enabled(&self, _chat_id: &str) -> Result<bool, SkyclawError> {
